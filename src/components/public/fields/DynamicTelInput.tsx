...
interface DynamicTelInputProps {
  field: FormField;
  value: string;
  error?: string;
  touched: boolean;
    ...
    <div className={`space-y-1 transition-all ${isAutoFilled ? 'rounded-lg border border-blue-200 bg-blue-50 p-3' : ''}`}>
      ...
      <div className="relative">
        <input
          ...
          placeholder={field.placeholder || 'e.g. +63 912 345 6789'}
          disabled={isLoading}
          autoComplete="tel"
...
export default DynamicTelInput;