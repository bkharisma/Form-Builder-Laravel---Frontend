...
interface DynamicTextAreaInputProps {
  field: FormField;
  value: string;
  error?: string;
  touched: boolean;
  ...
  return (
    <div className={`space-y-1 transition-all ${isAutoFilled ? 'rounded-lg border border-blue-200 bg-blue-50 p-3' : ''}`}>
      ...
      <textarea
        ...
        className={`
          w-full px-4 py-3 text-lg border-2 rounded-lg transition-colors resize-y
...
export default DynamicTextAreaInput;